...
fact{all v0 : u_Owner | v0.u_id = u_ownerId <=> v0 in u_Owner18} 

 fact { all alpha : u_Owner18 |  all v2 : u_Pet | alpha.u_id = v2.u_ownerId <=> v2 in alpha.u_pets } 

 fact { all v0 : u_Owner18 | all alpha : v0.u_pets |  all v3 : u_PetType | alpha.u_typeId = v3.u_id <=> v3 in alpha.u_type } 

 fact { all v0 : u_Owner18 | all alpha : v0.u_pets |  all v3 : u_Owner | alpha.u_ownerId = v3.u_id <=> v3 in alpha.u_owner } 

 fact { all v0 : u_Owner18 | all v1 : v0.u_pets | all alpha : v1.u_owner |  all v4 : u_Pet | alpha.u_id = v4.u_ownerId <=> v4 in alpha.u_pets } 

 sig u_Visit19 in u_Visit {} 
fact{all v0 : u_Visit | v0.u_petid = u_id(org.springframework.samples.petclinic.owner.Pet.id) <=> v0 in u_Visit19} 
