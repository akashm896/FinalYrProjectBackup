...
fact{all v0 : u_Owner | v0.id = ownerId <=> v0 in u_Owner18} 
 ...
 fact { all v0 : u_Owner18 | all alpha : v0.u_pets |  all v3 : u_Visit | alpha.id = v3.u_pet_id <=> v3 in alpha.u_visits } 
...
fact { mu___modelattribute__owner_telephone = u_Pi21.u_telephone }
